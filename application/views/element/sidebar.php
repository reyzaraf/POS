    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview <?php echo is_menu('user');?>">
          <a href="#"><i class="fa fa-share"></i> <span>user</span> <i class="fa fa-angle-left pull-right"></i></a>
          <ul class="treeview-menu">
            <li class="<?php echo is_menu('user');?>"><a href="<?php echo site_url('user');?>"><i class="fa fa-share" aria-hidden="true"></i> <span>User</span></a></li>
